...
export function PillNav({
  ...
  return (
    <div className="relative">
      <nav
        className={`flex w-full items-center justify-between md:w-max md:justify-start ${className}`}
        aria-label="Primary"
        style={cssVars}
      >
        <div
          ...
          >
            {items.map((item, i) => {
              ...
              const basePillClasses =
                "relative overflow-hidden inline-flex items-center justify-center h-full no-underline rounded-full box-border font-semibold text-[14px] leading-[0] whitespace-nowrap cursor-pointer px-0 transition-colors";
        ...
        <button
          ...
          className="relative flex flex-col items-center justify-center gap-1 rounded-full border-0 p-0 md:hidden"
          style={{
            width: "var(--nav-h)",
            height: "var(--nav-h)",
            background: "var(--base)",
      ...
      <div
        ref={mobileMenuRef}
        className="absolute left-0 right-0 top-[3.5em] z-[998] origin-top rounded-[27px] shadow-[0_8px_32px_rgba(0,0,0,0.12)] md:hidden"
        style={{
          ...cssVars,
          background: "var(--base)",
        }}
